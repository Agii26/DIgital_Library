...
<div class="bg-red-50 border border-red-200 rounded-2xl p-4 mb-6 flex items-center gap-4">
    ...
    <a href="{{ route('faculty.penalties.index') }}" class="ml-auto bg-red-500 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-red-600">
        View Penalties
    </a>
</div>
@endif
...
<div class="bg-orange-50 border border-orange-200 rounded-2xl p-4 mb-6 flex items-center gap-4">
    ...
    <a href="{{ route('faculty.borrows.index') }}" class="ml-auto bg-orange-500 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-orange-600">
        View Borrows
    </a>
</div>
@endif
...
<!-- Quick Actions -->
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
    <a href="{{ route('faculty.borrows.create') }}"
    ...
    <a href="{{ route('faculty.borrows.index') }}"
    ...
    <a href="{{ route('faculty.penalties.index') }}"
        class="bg-white rounded-2xl shadow p-4 text-center hover:shadow-md transition">
        <p class="text-2xl mb-1">💰</p>
...
<div class="bg-white rounded-2xl shadow p-6">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('faculty.borrows.index') }}" class="text-xs text-blue-500 hover:underline">View all</a>
    </div>
