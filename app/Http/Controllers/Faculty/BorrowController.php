...
class BorrowController extends Controller
{
    public function index()
    {
        ...
        return view('faculty.borrows.index', compact('borrows'));
    }
    ...
    public function create()
    {
        ...
        return view('faculty.borrows.create', compact('books'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // Check borrow limit
        $borrowLimit = Setting::get('faculty_borrow_limit', 5);
        ...
        return redirect()->route('faculty.borrows.index')
    ...
    public function books(Request $request)
    {
        ...
        return view('faculty.books.index', compact('books', 'categories'));
    }
}